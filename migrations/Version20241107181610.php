 ...
 */
final class Version20241107181610 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE services (id INT NOT NULL, type SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(500) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_addresses (address VARCHAR(255) NOT NULL, tariff_name VARCHAR(255) DEFAULT NULL, owner_id INT NOT NULL, status SMALLINT NOT NULL, balance NUMERIC(10, 2) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(address))');
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(15) NOT NULL, email VARCHAR(255) NOT NULL, language VARCHAR(2) DEFAULT \'en\' NOT NULL, theme VARCHAR(50) DEFAULT NULL, device_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX email ON users (email)');
        $this->addSql('COMMENT ON COLUMN users.device_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE user_addresses ADD CONSTRAINT FK_6F2AF8F27E3C61F9 FOREIGN KEY (owner_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_addresses DROP CONSTRAINT FK_6F2AF8F27E3C61F9');
