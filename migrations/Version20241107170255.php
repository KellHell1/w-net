 ...
 */
final class Version20241107170255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_addresses (address VARCHAR(255) NOT NULL, tariff_name VARCHAR(255) DEFAULT NULL, owner_id INT NOT NULL, status VARCHAR(20) NOT NULL, balance NUMERIC(10, 2) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(address))');
